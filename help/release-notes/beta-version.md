...
Esta página contiene registros de cambios para las versiones beta de Sampler. Obtenga información sobre cómo acceder a la versión beta en [Preguntas frecuentes](../faq.md).

>[!NOTE]
>
>Las versiones beta de Sampler no siempre están disponibles. Para saber cuándo se lanzarán las futuras versiones beta, siga los canales sociales de Substance 3D.
...
* [Firefly] Las imágenes generadas contienen manifiesto con procedencia
