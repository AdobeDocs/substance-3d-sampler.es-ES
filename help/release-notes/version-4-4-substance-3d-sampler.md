...
breadcrumb-title: ''
description: Consulte las notas de la versión 4.4 de Substance 3D Sampler para obtener más información sobre los flujos de trabajo generativos, incluidas las funciones de conversión de texto a textura e imagen a textura.
...
Texto a textura te permite explorar una nueva forma de crear materiales con un <b>mensaje de texto</b>. Puedes crear una textura en mosaico a partir de una descripción de texto detallada y seguir creando a partir del resultado mediante Imagen a material o cualquier filtro de Sampler para que sea exclusivamente tuyo.

## De imagen a textura

![imagen a textura](../assets/imagetoText_whatNewPanel.png "Imagen a textura")

Con Imagen a textura puedes crear texturas cuadradas en mosaico a partir de <b>tu propia imagen de referencia</b>, independientemente de que no sea cuadrada o no sea de mosaico. De este modo, se acerca a los resultados deseados sin necesidad de escribir el mensaje perfecto.\
La conversión de imagen en textura también puede ayudarte a ahorrar tiempo creando variaciones a partir del contenido que ya has creado.
...
* [IA generativa] De imagen a Textura (beta)
...
* bloqueo [Application] al abrir un archivo de proyecto dañado
...
* [Filters] El aumento de escala puede generar bloqueos en función de las capas de entrada
* [IA generativa] Posibles bloqueos al recibir resultados inesperados del servicio
* [Scripting] Bloqueo al cargar automáticamente un plugin desde la variable de entorno
