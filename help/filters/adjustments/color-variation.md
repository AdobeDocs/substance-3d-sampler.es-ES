...
* **Modo de selección de color**:\
  Elija si desea seleccionar los colores de origen de forma manual o automática. Si se elige el modo de selección **Manual**, usa los controles del **Vista 2D** para seleccionar los colores.
  * **Mostrar Ayudante De Texto**: alternar\
    Este control solo es visible si **Modo de selección de color** está establecido en **Manual**. Cuando se habilita, **Show Text Helper** agregará etiquetas de texto a los controles de **Vista 2D** para distinguir más fácilmente los controles de selección de color
...
1. Seleccione un **Modo de selección de color**. Con el modo manual seleccionado, aparecen controles en el **Vista 2D** que te permiten seleccionar el color base original que reemplazará el nuevo color. Habilite **Show Text Helper** para realizar un seguimiento de qué identificador está vinculado a qué color.
