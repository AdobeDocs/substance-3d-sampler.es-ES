---
helpx_url: "https://helpx.adobe.com/es/substance-3d-sampler/release-notes/old-versions/version-2020-1-2-1.html"
breadcrumb-title: ''
...
* **Usar ajustes preestablecidos de exportación para empaquetar texturas para un procesador o motor de juego específico** Ahora es posible elegir durante el proceso de exportación una configuración entre una lista de ajustes preestablecidos de exportación que convierten, empaquetan y asignan nombres a las texturas para una aplicación de terceros específica. El resultado de esta conversión se muestra en la lista de canales situada a la derecha de la interfaz.\
  ...
  * Lens Studio
  * Spark AR Studio
  * SPECULAR/Brillo de PBR de la Rugosidad metálica de PBR
...
Para obtener más información sobre cómo crear y usar un archivo de configuración, consulte la [página de documentación](https://helpx.adobe.com/es/substance-3d/unlisted/documentation/sadoc/resources-configuration-file-188976187.html) dedicada.
...
* **Enfoque de Vista 2D**\
  Ahora es posible utilizar el método abreviado &quot;F&quot; para restablecer y centrar el Vista 2D, al igual que con la vista 3D.
...
* **Control metálico con Filtro de material Bitmap 2**\
  El Filtro de material Bitmap 2 se ha actualizado para ofrecer un mayor control sobre el canal metálico. Ahora es posible utilizar una entrada de mapa de bits personalizada para ella o definir un color uniforme.
...
* [Exportar] Exportar ajuste preestablecido a Brillo de Specular PBR desde Rugosidad metálica PBR
...
* [Vista 2D] F método abreviado que se debe enfocar en la vista 2d
...
* [Contenido] Ajuste : añada la compatibilidad con el flujo de trabajo de specular/brillo de PBR
...
* bloqueo [Application] al cargar un material sin nombre
* [Aplicación] Reconocer los archivos que faltan al volver a importarlos
* [Aplicación] Solucionar bloqueo aleatorio al apagar
* [Aplicación] Se ha corregido un bloqueo raro al descargar un material en Crear
* [Aplicación] Se ha corregido el bloqueo aleatorio al utilizar controles de IU
...
* [Layers] Bloqueos al utilizar el parche de Clonar
...
* [Contenido] Parquet Pattern tiene en cuenta el canal de Oclusión ambiental
* pintura [Content]: mostrar la entrada de máscara al habilitar la máscara personalizada
* [Contenido] Motivo de Stonewall: elimina los posibles efectos de bandas en el mapa de normales
