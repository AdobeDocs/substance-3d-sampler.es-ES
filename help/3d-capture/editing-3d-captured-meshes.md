...
Cuando editas un objeto 3D capturado en Sampler, <b>puedes apilar mallas y Filtros de material de forma mixta</b>, se aplican automáticamente a la parte correcta de tus datos. La lista de filtros rápidos no distingue entre los dos tipos.

## Filtros de malla

Veamos primero los filtros de malla. Hay dos en Sampler: <b>mesh Transforme</b> y <b>mesh post process</b>.

<b>Transformación de malla</b> es un filtro sencillo que te permite <b>traducir</b>, <b>rotar</b> y <b>escalar</b> tu malla. Por lo general, puede voltear un objeto o ajustar su escala. Cualquier escaneo viene con un transforme preaplicado.
...
Los Filtros de material son mucho más diversos; cualquier cosa que se pueda usar en materiales normales se puede usar en el material de la malla de captura 3D, pero tenga en cuenta que los resultados podrían no funcionar siempre, ya que muchos filtros están pensados para materiales uniformes y de mosaico.
...
Cada objeto es diferente y, según el conjunto de datos, pueden ser necesarios ajustes específicos. Incluso puedes usar la <b>herramienta Sello de Clonar</b> para borrar partes de la textura que quieras eliminar, como capturar marcadores de ayuda. Solo ten en cuenta que cualquier filtro de material que utilice ubicaciones específicas de tu textura dependerá de tu diseño UV, así que haz el procesamiento de la malla antes que cualquier filtro de material.
