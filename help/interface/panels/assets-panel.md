...
* Use la barra de búsqueda para encontrar activos rápidamente.
* Filtrar activos por tipo.
* Agrupa activos por tipo o por categoría.
* Cambiar entre la vista de lista e icono.

## Adición de recursos al panel Activos

Para agregar tus propios activos al panel de activos, haz clic en **+** en la esquina inferior derecha del **panel de activos**. Busca la ubicación de tu activo, selecciónalo y haz clic en **Abrir**. Puedes eliminar activos personalizados del **panel Activos** arrastrándolos sobre la papelera.
...
>[!NOTE]
>
> Solo los activos personalizados se pueden eliminar en el **panel Activos**. No es posible eliminar los recursos predeterminados de Sampler.
