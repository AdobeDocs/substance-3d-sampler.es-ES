...
Sampler tiene dos barras laterales: **Barra lateral izquierda** y **Barra lateral derecha**.

![](../assets/Sidebars.png.img.png)

## Barra lateral izquierda

Desde la **barra lateral izquierda**, puedes:
...
* Añada rápidamente filtros a la pila de capas:
  ...
  * **Transformar:** Cambiar el tamaño de imágenes y materiales con identificadores en la Vista 2D **2&rbrace;.**
...
* Vuelva a abrir los siguientes paneles cuando estén cerrados:
  ...
  * [El **panel Activos**.](panels/assets-panel.md)
  * [El **panel Configuración de canal**.](panels/channel-settings-panel.md)

Para obtener más información sobre los filtros disponibles en la **barra lateral izquierda**, consulte [Herramientas y widgets](tools-and-widgets/tools-and-widgets.md).

## Barra lateral derecha

La **barra lateral derecha** contiene los siguientes paneles cuando están cerrados:

* [El **panel Capas**.](panels/layers-panel.md)
* [El **panel Propiedades**.](panels/properties-panel.md)
* [El **Panel Parámetros expuestos**.](panels/exposed-parameters-panel.md)
* [El **panel Tamaño físico**.](panels/physical-size-panel.md)
* [El **panel Metadatos**.](panels/metadata-panel.md)
* [El **panel Exportar**.](panels/share-panel.md)
