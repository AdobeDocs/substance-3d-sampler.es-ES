...
El algoritmo **B2M** utiliza el método Bitmap to Material basado en Substance para generar varios canales, como color base, normal, metálico, rugosidad y oclusión ambiental, utilizando técnicas procedimientas.
