...
# Enviar a cualquier aplicación

A partir de la versión 4.5 de Sampler, ahora puede enviar sus contenidos desde Sampler directamente a cualquier aplicación en la que se haya implementado el conector.\
...
Hoy en día el Enviar a está disponible en Blender, Unreal Engine, Unity, 3ds Max, y Maya a través de los Plugins de Substance.

## Versiones de aplicaciones compatibles

Para poder utilizar Enviar a es necesario tener la versión correcta de Sampler, de la aplicación de terceros y de los complementos.

Estas son las versiones mínimas que necesita para poder utilizar Enviar a:

* <b>Complemento de motor irreal</b>
  * Cualquier cosa posterior a UE5.4 es totalmente compatible.
  * *Publicado en la tienda de la UE*
...
* <b>Complemento Unity v3.11+</b>
  ...
  * *El complemento debe descargarse de la tienda de recursos*
