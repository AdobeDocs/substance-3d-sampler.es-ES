...
* **Modo de validación**:\
  Seleccione si desea validar los valores de albedo (color base o difusión), los valores metálicos o los valores metálicos y de albedo. Otros parámetros se actualizarán según esta selección
  * **Modo de validación: Albedo**
    ...
    * **Mapa de superposición**: alternar\
      Cambiar entre el modo de superposición: si está activado, el mapa de color base se superpondrá con los píxeles no válidos.
    * **Ocultar validación en el Color base**: alternar\
...
En el mundo real, hay algunos colores y combinaciones de propiedades que son imposibles o increíblemente raras. Por ejemplo, casi nada en el mundo real tiene un albedo o color base blanco o negro puro.
...
Si utiliza el modo de validación de color, las áreas no verdes generalmente significan que hay valores en el color base cercanos al negro o al blanco. Usa filtros de ajuste como **Matiz/Saturación** o **Brillo/Contraste** para ajustar los valores de tu canal de color hasta que el **filtro Validación PBR** no muestre más errores.
