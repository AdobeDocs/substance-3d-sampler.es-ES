---
helpx_url: "https://helpx.adobe.com/es/substance-3d-sampler/release-notes/version-3-3.html"
breadcrumb-title: ''
...
**Substance 3D Sampler 3.3.0** presenta una serie de nuevas herramientas, contenido y funciones para crear y editar materiales y luces ambientales con mayor facilidad.
...
Substance 3D Sampler ahora utiliza esta misma tecnología, lo que te permite limpiar materiales y luces ambientales de PBR. En los materiales PBR, el Relleno según el contenido se aplica en todos los canales. No es necesario procesar cada canal por separado.
...
La edición de luces ambientales e imágenes 360 puede resultar difícil cuando se muestran como imágenes normales. Todos los elementos están distorsionados, por lo que es casi imposible editarlos. Con la nueva proyección esférica, puedes navegar en 360° y editar con herramientas especializadas como el Nadir patch, el relleno según el contenido y todas las luces procedimientas sin distorsión. Ahora es más fácil, por ejemplo, editar o limpiar líneas rectas, quitar el trípode de la cámara y colocar las luces de línea perfectamente.

Echa un vistazo al nuevo tutorial para [crear luces ambientales](https://www.youtube.com/watch?v=cfW9IyoTXQ8) con este nuevo modo.
...
La configuración del visor es persistente por tipo de recurso (material o luz ambiental). Puede definir la malla, las texturas predeterminadas o el campo de visión de la cámara para cada tipo de recurso, de modo que sea más fácil cambiar de uno a otro para trabajar en el contexto adecuado.

## Widgets mejorados

### Sello de Clonar

Con esta actualización del sello del Clonar, puede pintura varios trazos de sello con varios orígenes en una sola capa y acceder al historial de sellos en la pila de capas. Además, ahora puede ver el resultado de la marca directamente en la vista previa del pincel antes de pintar. Esto facilita la limpieza de materiales y evita muchas idas y venidas entre vistas.
...
La nueva interfaz de usuario, similar a los productos de Adobe más recientes como Fresco, le permite mover la barra de herramientas a cualquier lugar del Vista 2D, que se muestra vertical u horizontalmente. Mientras pinta, cambie entre el pincel y el borrador con la tecla E y utilice las nuevas opciones de mosaico para controlar mejor lo que pintura.
...
* [Contenido] El Relleno según el contenido (Content Aware Fill) está trabajando en imágenes, materiales PBR y luces ambientales
* [Contenido] Añada el parámetro &quot;Conservar segmentación&quot; a Imagen a material (con tecnología de IA)
* [Contenido] El filtro Transformar Perspectiva puede mostrar una cuadrícula entre sus cuatro puntos
...
* [Herramientas] El cursor del sello del Clonar ofrece una vista previa de lo que se va a estampar
* [Herramientas] Previsualizar el contenido original en el cursor del Borrador al utilizar el sello del Clonar
* [Herramientas] Al pulsar Ctrl y hacer clic se crea un nuevo sello en la capa Sello del Clonar
...
* [Herramientas] Ocultar/mostrar la superposición sobre el Vista 2D al pintar
...
* [vista 2D] Nuevo modo de Proyección esférica al crear una luz ambiental
* [vista 2D] La herramienta Pincel es compatible con el modo de proyección esférica
* La herramienta Posición de [vista 2D] es compatible con el modo de proyección esférica
* [vista 2D] Se admite la función Deshacer/Rehacer en el modo de proyección esférica.
...
* [Filtros compuestos] Los filtros compuestos controlan las variaciones para trabajar en imágenes, materiales PBR y luces ambientales
...
* [Aplicación] La aplicación puede entrar en bloqueo al cambiar a la Vista 2D
...
* [Contenido] Los detalles del mapa de altura desaparecen al utilizar la Fusión de opacidad
