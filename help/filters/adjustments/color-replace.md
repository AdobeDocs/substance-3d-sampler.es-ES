---
helpx_url: "https://helpx.adobe.com/es/substance-3d-sampler/filters/adjustments/color-replace.html"
breadcrumb-title: ''
description: Utilice el filtro Reemplazar color en Substance 3D Sampler para reemplazar colores específicos en texturas con nuevos valores de color.
...
Esta máscara es independiente de la máscara creada en **Parámetros básicos**: puedes usar una máscara personalizada para pintura o usar una imagen para especificar las áreas que se verán afectadas por el filtro **Reemplazo de color** en su conjunto.
...
1. Agregue el filtro **Reemplazo de color** a la pila de capas
...
1. Mueva el control en **Vista 2D** sobre el color que desea reemplazar.
